...
operation::query-events[snippets='request-parameters,curl-request,http-request,http-response,response-body,response-fields,links']
...
operation::get-an-event[snippets='request-fields,curl-request,http-response,links,http-response,response-body,response-fields,links,path-parameters']
